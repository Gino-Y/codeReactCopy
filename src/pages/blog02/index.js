...
import img01 from '../../image/imgB01.jpg';
import img02 from '../../image/imgB02.jpg';
import img03 from '../../image/imgB03.jpg';
        ...
        <div className={styles.global}>
            ...
            <div className={styles.secondLine}>
                <div className={styles.secondLineInter}>
                    <BlogRole img={girlxx02} name={'Tina'} job={'designer'} />
            ...
            <div className={styles.fifthLine}>
                <Divider>
                    <Avatar size={64} icon={<UserOutlined />} src={girlxx02} />
                </Divider>
            </div>
            <CopyRightComponent />
        </div>
